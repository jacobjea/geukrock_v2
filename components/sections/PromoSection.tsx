...
const toneStyles = {
  ...
  paper: {
    ...
    eyebrow: "text-black/62",
    description: "text-black/78",
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-6 sm:p-8 lg:p-10">
                  <div className="max-w-[23rem] space-y-4">
                    <p
                      className={`text-[12px] font-medium uppercase tracking-[0.22em] ${tone.eyebrow}`}
                    >
                      {banner.eyebrow}
                    </p>
                    ...
                    <p className={`max-w-md text-[15px] leading-7 ${tone.description}`}>
                      {banner.description}
                    </p>
                  </div>
                  ...
                  <div className="mt-10 flex flex-wrap items-end justify-between gap-4">
                    <div className="flex flex-wrap gap-3">
                      <a
                        className={`inline-flex h-12 items-center justify-center rounded-full px-6 text-[14px] font-medium transition-colors duration-300 ${tone.button}`}
                        href="#"
                      >
                        {banner.cta}
                      </a>
                      <a
                        className={`inline-flex h-12 items-center justify-center rounded-full border px-6 text-[14px] font-medium transition-colors duration-300 ${tone.secondary}`}
                        href="#"
                      >
                        {banner.secondaryCta}
                      </a>
                    ...
                    <p
                      className={`text-[11px] font-medium uppercase tracking-[0.24em] ${tone.eyebrow}`}
                    >
                      {banner.accent}
                    </p>
                  </div>
